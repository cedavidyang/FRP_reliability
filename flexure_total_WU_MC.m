function resistSmp = flexure_total_WU_MC(iDesignCase, hSmp, fcSmp, fctSmpNoBrittleFactor, EFrpSmp, fFrpSmp, fsSmp, areaSteelSmp)
...
eDebond = psi_f *(0.23*(fcMPA/gammaConcrete).^(0.2)./(EfrpMPA.*tFrpMM).^(0.35))./gammaBond;
