function [resistMean, resistStd, resistSmp] = determine_flexure(iDesignCase, nSim)
...
switch DESIGN_CODE
    case {'aci' 'ACI'}
        resist0 = flexure_total_ACI_MC(iDesignCase, hSmp, fcSmp, sqrtFcSmp, EFrpSmp, fFrpSmp, fsSmp, areaSteelSmp);
    case {'hk' 'HK'}
        resist0 = flexure_total_HK_MC(iDesignCase, hSmp, fcSmp, fctSmp, EFrpSmp, fFrpSmp, fsSmp, areaSteelSmp);
    case{'GB' 'gb'}
        resist0 = flexure_total_GB_MC(iDesignCase, hSmp, fcSmp, fctSmpNoBrittleFactor, EFrpSmp, fFrpSmp, fsSmp, areaSteelSmp);
    otherwise
end
