    ...
    case {'GB', 'gb'}
        for iFactorFrp = 1:nFactorFrp
            switch SUB_TEST_DATABASE_NAME
                case {'shear+side', 'shear+U'}
                    [resistanceDesign(:,iFactorFrp), isOverReinforce(:,iFactorFrp),...
                        roSteel(:,iFactorFrp), resistReinforce(:,iFactorFrp)] = shear_total_GB('DESIGN_VALUE',[1.40; FACTOR_FRP(iFactorFrp)]);
                case {'shear+W'}
                    [resistanceDesign(:,iFactorFrp), isOverReinforce(:,iFactorFrp),...
                        roSteel(:,iFactorFrp), resistReinforce(:,iFactorFrp)] = shear_total_GB('DESIGN_VALUE',[FACTOR_FRP(iFactorFrp); 1.00]);                    
                case {'flexure+IC', 'flexure+ic'}
                    [resistanceDesign(:,iFactorFrp), failMode(:,iFactorFrp),...
